    ...
    <ThemedSection className="min-h-screen p-6">
      <div className="flex flex-col-reverse md:flex-row items-center justify-between w-full max-w-7xl mx-auto gap-12 mt-16 md:mt-24">
        ...
        <div className="md:w-1/2 flex justify-center md:justify-start">
          <div className={`relative w-full max-w-md md:max-w-lg p-8 rounded-3xl
            ...
            <h1 className={`text-5xl md:text-6xl font-bold leading-tight ${theme.text} drop-shadow-lg`}>
            ...
            <div className="flex flex-col gap-4 md:flex-row">
              <SignInButton>
                <button className={`px-6 py-3 ${theme.headerFooterBg} ${theme.headerFooterText} font-medium rounded-lg shadow-lg hover:shadow-2xl transition duration-300`}>
                  Sign In
                </button>
              </SignInButton>
              <SignOutButton>
        ...
        <div className="md:w-1/2 flex justify-center md:justify-end py-16 relative">
          <div className={`relative w-full max-w-md md:max-w-xl rounded-3xl p-3
            ${theme.mode === "light" ? "bg-white/20 border-white/40" : "bg-gray-900/30 border-gray-200/30"}
